...
from .views import (BulkUserCreationView, MyTokenObtainPairView, UserLoginView, UserRegisterView,
...
urlpatterns = [
    ...
    path('auth/bulk-create-users/', BulkUserCreationView.as_view(), name='bulk_create_users')
]
