...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='my_user',
            name='blood_group',
            field=models.CharField(blank=True, choices=[('A+', 'Apositive'), ('A-', 'Anegative'), ('B+', 'Bpositive'), ('B-', 'Bnegative'), ('O+', 'Opositive'), ('O-', 'Onegative'), ('AB+', 'Abpositive'), ('AB-', 'Abnegative')], max_length=3),
        ),
        migrations.AlterField(
            model_name='my_user',
            name='phone_number',
